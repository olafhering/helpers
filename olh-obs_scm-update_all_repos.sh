...
then
  ...
  if ${push}
  then
  git push github_olafhering 'refs/remotes/upstream/stable-11.*:refs/heads/stable-11.*' &> $t/qemu.github_olafhering &
  git push gitlab_olafhering 'refs/remotes/upstream/stable-11.*:refs/heads/stable-11.*' &> $t/qemu.gitlab_olafhering &
  git push gitlab_olh        'refs/remotes/upstream/stable-11.*:refs/heads/stable-11.*' &> $t/qemu.gitlab_olh        &
